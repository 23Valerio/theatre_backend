...
from app.views import ShowListCreateView, GalleryListCreateView, ShowUpdateView, SliderListCreateView, GalleryListUpdateView, SliderListUpdateView, UserDetailView, ByTicketView, FutureShows
...
urlpatterns = [
    ...
    path('api/mytickets/', UserDetailView.as_view(), name='user-detail'),
